...
export const translations: Translations = {
  ...
  buyStep1Desc: { EN: 'Download Phantom or Solflare wallet from the app store or as a browser extension.', ZH: '从应用商店下载 Phantom 或 Solflare 钱包，或者作为浏览器扩展程序安装。', JA: 'App Store から Phantom または Solflare ウォレットをダウンロードするか、ブラウザ拡張機能としてインストールします。', KO: '앱 스토어에서 Phantom 또는 Solflare 지갑을 다운로드하거나 브라우저 확장 프로그램으로 설치하십시오.', RU: 'Загрузите кошелек Phantom или Solflare из магазина приложений или в виде расширения для браузера.' },
  ...
  buyStep3Desc: { EN: 'Connect to Jupiter (jup.ag) or Raydium, paste the $FireHorse contract address, and swap your SOL.', ZH: '连接到 Jupiter (jup.ag) 或 Raydium，粘贴 $FireHorse 合约地址，并兑换您的 SOL。', JA: 'Jupiter (jup.ag) または Raydium に接続し、$FireHorse のコントラクトアドレスを貼り付けて、SOL を交換します。', KO: 'Jupiter (jup.ag) 또는 Raydium에 연결하고 $FireHorse 컨트랙트 주소를 붙여넣은 다음 SOL을 교환하십시오.', RU: 'Подключитесь к Jupiter (jup.ag) или Raydium, вставьте адрес контракта $FireHorse и обменяйте свой SOL.' },
